...
@EnableScheduling
public class BanlnRabbitmqApplication {
	...
	public CommandLineRunner tutorial() {
		return new BanlnRabbitmqRunner();
	}
	...
	public static void main(String[] args) {
		SpringApplication.run(BanlnRabbitmqApplication.class, args);
	}
