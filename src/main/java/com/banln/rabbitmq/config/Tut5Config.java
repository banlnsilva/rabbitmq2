package com.banln.rabbitmq.config;
...
import com.banln.rabbitmq.receive.Tut5Receiver;
import com.banln.rabbitmq.send.Tut5Sender;
...
public class Tut5Config {
    ...
    private static class ReceiverConfig {
		...
		public Queue autoDeleteQueue1() {
			return new Queue("q.kor.upbit");
		}

        @Bean
        public Queue autoDeleteQueue2() {
            return new Queue("q.kor.bithumb");
        }
